var s=`<pre><code class="language-vue"><span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;wrapper&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">v-size-observer</span>=<span class="hljs-string">&quot;options&quot;</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;box&quot;</span> @<span class="hljs-attr">sizechange</span>=<span class="hljs-string">&quot;handleSizeChange&quot;</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;tips&quot;</span>&gt;</span>Delay: 1s, Immediate: false<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;text&quot;</span>&gt;</span>{{ width }} <span class="hljs-symbol">&amp;times;</span> {{ height }}<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
...
<span class="hljs-comment">// import { SizeObserverDirective, SizeObserverEvent } from &#x27;../../../../packages/size-observer&#x27;;</span>
<span class="hljs-keyword">import</span> {
  SizeObserverDirective,
  SizeObserverEvent,
} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@clownjs/size-observer&quot;</span>;
