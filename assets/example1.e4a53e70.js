...
<span class="hljs-keyword">import</span> { defineComponent, ref, onMounted, onUnmounted, Ref } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;vue&quot;</span>;
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> defineComponent({
  <span class="hljs-function"><span class="hljs-title">setup</span>(<span class="hljs-params"></span>)</span> {
    <span class="hljs-keyword">const</span> sakuraContainer: Ref&lt;HTMLCanvasElement | <span class="hljs-literal">null</span>&gt; = ref(<span class="hljs-literal">null</span>);
    <span class="hljs-keyword">let</span> resizeTimer: NodeJS.Timeout;
    <span class="hljs-keyword">let</span> sakura: SakuraCanvas | <span class="hljs-literal">null</span> = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">const</span> updateCanvasSize = <span class="hljs-function">() =&gt;</span> {
      <span class="hljs-keyword">const</span> container: HTMLCanvasElement | <span class="hljs-literal">null</span> = sakuraContainer.value;
      <span class="hljs-keyword">if</span> (container !== <span class="hljs-literal">null</span>) {
        ...
        <span class="hljs-keyword">if</span> (sakura <span class="hljs-keyword">instanceof</span> SakuraCanvas) {
          sakura.setConfig({
            canvasWidth,
            canvasHeight,
          });
    ...
    onMounted(<span class="hljs-function">() =&gt;</span> {
      ...
      <span class="hljs-keyword">if</span> (container !== <span class="hljs-literal">null</span>) {
        ...
        } <span class="hljs-keyword">catch</span> (ex: any) {
